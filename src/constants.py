...
AGENTICNESS = {
    1: {
        ...
        "yegge_alignment_explanation": "Accurately demonstrates near-zero/prompt-only AI: human owns context, no tools, no autonomy.",
        "yegge_alignment_limit": "Not advanced autonomy; high score comes from faithful Stage 1 simulation.",
