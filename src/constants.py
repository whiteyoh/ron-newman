...
USE_CASE_OPTIONS = {
    "uk_year10_teacher": "Use case for all levels: help a UK Year 10 teacher create engaging, classroom-ready lesson and revision plans with clear sequence, timings, activities, assessment, and differentiation. Use provided context and reasonable defaults when details are missing; do not ask follow-up questions.",
