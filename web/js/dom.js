...
export const refs = {
  ...
  runInsightPanel: el('run-insight-panel'),
  runInsightLevel: el('run-insight-level'),
  runInsightCopy: el('run-insight-copy'),
  finalOutputPanel: el('final-output-panel'),
  finalOutputStatus: el('final-output-status'),
  finalOutputBody: el('final-output-body'),
  learningTakeawayPanel: el('learning-takeaway-panel'),
  learningTakeawayCopy: el('learning-takeaway-copy'),
